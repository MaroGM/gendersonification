...
song1 = [
	['c', 4], ['d', 4], ['e', 4], ['f', 4], ['g', 4], [
		'a', 4], ['b', 4], ['c5', 2], ['r', 1],
	['c3', 4], ['d3', 4], ['e3', 4], ['f3', 4], [
		'g3', 4], ['a3', 4], ['b3', 4], ['c4', 2], ['r', 1],
	['c1*', 1], ['c2*', 1], ['c3*', 1], ['c4*',
										 1], ['c5*', 1], ['c6*', 1], ['c7*', 1], ['c8*', 1],
]
...
song3 = (
	...
	('bb*', 8), ('d6', 8), ('c6', 8), ('bb5', 16), ('ab5', 16), ('g5',
																 16), ('ab5', 16), ('c5', 16), ('d5', 16), ('eb5', -4),
)
...
song4_rh = (
	...
	('g*', 4), ('f#', 8), ('e', 8), ('d#*', 4), ('e', 8), ('f#', 8),
	('b3*', 4), ('c#', 8), ('d#', 8), ('e*', 4), ('d', 8), ('c', 8),
	('b3*', 4), ('a3', 8), ('g3', 8), ('g3*', 32), ('f#3*', 32), ('g3*', 32), ('f#3*',
																			   32), ('g3*', 32), ('f#3*', 32), ('g3*', 32), ('f#3*', 6.4), ('g3', 8), ('g3*', -2),
)
...
def make_wav(song, callback, bpm=120, transpose=0, leg_stac=.9, boost=1.1, repeat=0, fn="out.wav", silent=True):
	f = wave.open(fn, 'w')
	...
	for n in range(900):
		decay[n] = exp(linint(
			((0, log(3)), (3, log(5)), (5, log(1.)), (6, log(.8)), (9, log(.1))), n / 100.))
			...
			if x[0] != 'r':
				...
				if len(x[0]) > 3:
					...
					if hexvol.upper() == 'X':
						...
						boost = np.interp(int(hexvol, 16), [0,15], [0.5,5])
					vol = boost
					note = x[0][:-2]
...
if __name__ == '__main__':
	...
	make_wav((('c3*A', 4), ('d3*A', 4), ('g2*A', 4), ('c3*X', 1)), transpose = 0)
	...
	#mix_files('output.wav', 'file2.wav', 'output2.wav', chann=1)
